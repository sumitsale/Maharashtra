				...
				<?php for($i= 0; $i < count($wars); $i++) { ?>
                                                ...
                                                <article class="article-medium">
                                                        <div class="row">
                                                                ...
                                                                <!--Content-->
                                                                <div class="col-sm-6">
                                                                        <h4><a href="#"><?php echo $wars[$i]['title']; ?>
                                                                        <p class="post-meta">
                                                                                <a href="#"><span class="fa fa-clock-o"></span> <?php echo date('F m, Y', strtotime($wars[$i]['blog_date']));?></a> 
                                                                                <!--<a href="#"><span class="fa fa-user"></span> FriskaMax</a>--> 
                                                                                <a href="#"><span class="fa fa-comments"></span> <?php echo $wars[$i]['view_count']; ?></a> 
                                                                                <!--<a href="#"><span class="fa fa-eye"></span> 4,448</a>-->
                                                                        </p>
                                                                        <p>
                                                                                 <?php echo substr(strip_tags($wars[$i]['english_content']),0,220).'...'; ?>
                                                                        </p>                                    
                                                                </div>
                                                        </div>
