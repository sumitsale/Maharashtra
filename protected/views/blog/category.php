                  ...
                  <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/728.png" alt="ads">
                                                ...
                                                <article class="article-medium">
                                                        <div class="row">
                                                                ...
                                                                <!--Content-->
                                                                <div class="col-sm-6">
                                                                        <h4><a href="<?php echo Yii::app()->createUrl('blogdetail/index',array('name'=> str_replace(' ','-',$fort_blogs[$i]['title'])))?>"><?php echo $fort_blogs[$i]['title']; ?></a></h4>
                                                                        <p class="post-meta">
                                                                                <a href="javascript::void(0);"><span class="fa fa-clock-o"></span> <?php echo date('F m, Y', strtotime($fort_blogs[$i]['blog_date']));?></a> 
