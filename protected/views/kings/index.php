				...
				<?php for($i= 0; $i < count($kings); $i++) { ?>
                                                ...
                                                <article class="article-medium">
                                                        <div class="row">
                                                                        ...
                                                                        <div class="frame">
                                                                                <a class="image" href="#">
                                                                                        <figure class="image-holder">
                                                                                                <img width="95px;" height="75px;" src="<?php echo Yii::app()->baseurl.'../images/kings/thumbnail/'.$kings[$i]['thumbnail']; ?>" alt="<?php echo $kings[$i]['thumbnail_alt']; ?>">
                                                                                        </figure>
                                                                ...
                                                                <!--Content-->
                                                                <div class="col-sm-6">
                                                                        <h4><a href="#"><?php echo $kings[$i]['title']; ?>
                                                                        <p class="post-meta">
                                                                                <a href="#"><span class="fa fa-clock-o"></span> <?php echo date('F m, Y', strtotime($kings[$i]['blog_date']));?></a> 
                                                                                <!--<a href="#"><span class="fa fa-user"></span> FriskaMax</a>--> 
                                                                                <a href="#"><span class="fa fa-comments"></span> <?php echo $kings[$i]['view_count']; ?></a> 
                                                                                <!--<a href="#"><span class="fa fa-eye"></span> 4,448</a>-->
                                                                        </p>
                                                                        <p>
                                                                                 <?php echo substr(strip_tags($kings[$i]['english_content']),0,220).'...'; ?>
                                                                        </p>                                    
                                                                </div>
                                                        </div>
                                                ...
                                                <ul class="pagination">
														...
														<?php for($i=1;$i<=$total_page;$i++) { ?>
															...
															<?php }  else { ?>
																<li><a href="<?php echo Yii::app()->createUrl('kings/index', array('page'=>$i))?>"><?php echo $i; ?></a></li>			
															<?php } ?>
