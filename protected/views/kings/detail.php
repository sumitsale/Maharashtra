                                        ...
                                        <main id="main-content" class="col-md-8">
                                                ...
                                                <article class="article-large hentry">      
                                                        ...
                                                        <div class="frame thick clearfix">
                                                                <a href="<?php echo Yii::app()->baseurl.'../images/kings/detail_thumbnail/'.$blog_detail[0]['detail_thumbnail']; ?>" class="image" data-lightbox title="<?php echo $blog_detail[0]['detail_alt']; ?>">
                                                                        <figure class="image-holder">
                                                                                <img src="<?php echo Yii::app()->baseurl.'../images/kings/detail_thumbnail/'.$blog_detail[0]['detail_thumbnail']; ?>" alt="<?php echo $blog_detail[0]['detail_alt']; ?>">
                                                                        </figure>
                                                ...
                                                <nav class="post-navigation" role="navigation">
                                                        ...
                                                        <div class="nav-links">
                                                                ...
                                                                <div class="nav-previous">
                                                                        <a href="<?php echo Yii::app()->createUrl('kings/detail',array('name'=> str_replace(' ','-',$prev[0]['title'])))?>" rel="prev">
                                                                ...
                                                                <?php  if(count($next)>0) { ?>
                                                                <div class="nav-next">
                                                                        <a href="<?php echo Yii::app()->createUrl('kings/detail',array('name'=> str_replace(' ','-',$next[0]['title'])))?>" rel="prev">
                                                ...
                                                <section class="widget">
                                                        ...
                                                        <?php for($i=0;$i<count($related);$i++) {  ?>
                                                                <div class="article-small col-md-3 col-sm-6">                                        
                                                                        <a href="<?php echo Yii::app()->createUrl('kings/detail',array('name'=> str_replace(' ','-',$related[$i]['title'])))?>" class="image">
                                                                                <figure class="image-holder">
                                                                                        <img src="<?php echo Yii::app()->baseurl.'../images/kings/thumbnail/'.$related[$i]['thumbnail']; ?>" alt="<?php echo $related[$i]['thumbnail_alt']; ?>">
                                                                                </figure>
                                                                                <div class="image-light"></div>
                                                                                <span class="dashicons dashicons-format-audio"></span>
                                                                        </a>
                                                                        <h5>
                                                                          <a href="<?php echo Yii::app()->createUrl('kings/detail',array('name'=> str_replace(' ','-',$related[$i]['title'])))?>">
