...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('fort_category_id')); ?>:</b>
	<?php echo CHtml::encode($data->fort_category_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('blog_detail_thumbnail')); ?>:</b>
	<?php echo CHtml::encode($data->blog_detail_thumbnail); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('blog_detail_alt')); ?>:</b>
	<?php echo CHtml::encode($data->blog_detail_alt); ?>
	<br />
