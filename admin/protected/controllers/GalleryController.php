...
class GalleryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Gallery']))
		{
			...
			$model->thumbnail = $_FILES['Gallery']['name']['thumbnail'] != '' ? $_FILES['Gallery']['name']['thumbnail'] : '';
			...
			if($model->save()) {
				...
				if($model->thumbnail !='')
				{
					...
					$model->thumbnail->saveAs(Yii::app()->basePath  . '/../../images/gallery/thumbnail/'. $model->thumbnail );			
					
					$resize = new ResizeImage(Yii::app()->basePath . '/../../images/gallery/thumbnail/'. $model->thumbnail );
					$resize->resizeTo(350, 185, 'exact');
					$resize->saveImage(Yii::app()->basePath . '/../../images/gallery/thumbnail/'. $model->thumbnail );
				}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Gallery']))
		{
			$model->attributes=$_POST['Gallery'];
			$model->date_modified = date("Y-m-d H:i:s");
			$model->thumbnail = isset($_FILES['Gallery']['name']['thumbnail']) && $_FILES['Gallery']['name']['thumbnail']!=''  ? $_FILES['Gallery']['name']['thumbnail'] : $thumbnail;
