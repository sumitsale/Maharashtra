...
/**
 * This is the model class for table "kings".
 *
 * The followings are the available columns in table 'kings':
 * @property integer $id
 ...
 */
class Kings extends CActiveRecord
{
	/**
	 ...
	 * @return Kings the static model class
	 */
